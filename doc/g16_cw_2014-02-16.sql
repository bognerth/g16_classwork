...
SELECT pg_catalog.setval('answers_id_seq', 241, true);
...
SELECT pg_catalog.setval('classtest_events_id_seq', 1, true);
...
SELECT pg_catalog.setval('questions_id_seq', 76, true);
...
SELECT pg_catalog.setval('testtypes_id_seq', 2, true);
